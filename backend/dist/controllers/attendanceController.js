...
export const downloadMonthlyReport = async (req, res) => {
    try {
        ...
        // Generate PDF
        const filePath = await PDFService.generateMonthlyAttendanceReport(reportData.className, monthNum, yearNum, reportData.students, {}, totalDays, reportData.classPercentage);
...
export const downloadYearlyReport = async (req, res) => {
    try {
        ...
        // Generate PDF
        const filePath = await PDFService.generateYearlyAttendanceReport(reportData.className, yearNum, reportData.students, reportData.monthlyData, reportData.overallPercentage);
