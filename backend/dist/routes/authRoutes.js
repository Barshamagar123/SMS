...
router.get('/students/statistics', authenticate, requireAdmin, authController.getStudentStatistics);
// EXPORT STUDENTS DATA (Admin & SuperAdmin)
router.get('/students/export', authenticate, requireAdmin, authController.exportStudentsData);
// GET STUDENT DETAILS BY ID (Admin & SuperAdmin)
router.get('/students/:id/details', authenticate, requireAdmin, authController.getStudentDetailsById);
// GET STUDENT PHOTO BY ID (Admin & SuperAdmin)
router.get('/students/:id/photo', authenticate, requireAdmin, authController.getStudentPhotoById);
// UPDATE STUDENT STATUS (Activate/Deactivate)
router.patch('/students/:id/status', authenticate, requireAdmin, authController.updateStudentStatus);
// RESET STUDENT PASSWORD (Admin & SuperAdmin)
router.post('/students/:id/reset-password', authenticate, requireAdmin, authController.resetStudentPassword);
