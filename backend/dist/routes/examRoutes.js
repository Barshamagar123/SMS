...
import { createExamType, getAllExamTypes, createExam, getExamsByClass, getExamsForTeacher, getStudentsForMarksEntry, enterMarks, getExamResults, lockExam, unlockExam, getMyExamResults, initializeGrades } from '../controllers/examController.js';
const router = Router();
// ================= EXAM TYPE ROUTES =================
