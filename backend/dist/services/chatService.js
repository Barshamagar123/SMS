...
export class ChatService {
    ...
    static async sendMessage(conversationId, senderId, receiverId, message, attachmentUrl, attachmentType) {
    ...
    static async getStudentTeachers(studentUserId) {
    ...
    static async getTeacherStudents(teacherUserId) {
        ...
        teacherAssignments.forEach((ta) => {
            if (ta.classSubject?.class?.students) {
                ta.classSubject.class.students.forEach((student) => {
