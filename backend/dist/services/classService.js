...
export class ClassService {
    ...
    static async createClass(data) {
        ...
        if (existing)
            throw new Error(`Class ${data.name} ${data.section} already exists`);
    ...
    static async updateClass(id, data) {
        ...
        if (duplicate)
            throw new Error('Another class with this name and section already exists');
    ...
    static async assignSubjectToClass(classId, subjectId) {
    ...
    static async removeSubjectFromClass(classId, subjectId) {
