...
export const createExamType = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getAllExamTypes = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const createExam = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const missingFields = [];
    if (!examTypeId) missingFields.push('examTypeId');
...
export const getExamsByClass = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getExamsForTeacher = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getStudentsForMarksEntry = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const enterMarks = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { examId } = req.params;
...
export const getExamResults = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { examId } = req.params;
    const examIdNum = toNumber(examId);
...
export const lockExam = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { examId } = req.params;
    const userId = req.user?.id;
...
export const unlockExam = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { examId } = req.params;
    const examIdNum = toNumber(examId);
...
export const getMyExamResults = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = req.user?.id;
    const { academicYearId } = req.query;
...
export const initializeGrades = async (req: AuthenticatedRequest, res: Response) => {
  try {
