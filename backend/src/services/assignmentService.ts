...
export class AssignmentService {
    ...
    static async createAssignment(data: {
        ...
        if (!classSubject) throw new Error('Subject is not assigned to this class. Please assign subject to class first.');
        ...
        if (existing) throw new Error('This teacher is already assigned to this subject in this class for this academic year');
    ...
    static async getAllAssignments(teacherId?: number) {
    ...
    static async assignmentExists(id: number): Promise<boolean> {
